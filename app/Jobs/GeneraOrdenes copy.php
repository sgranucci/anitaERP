...
class GeneraOrdenes implements ShouldQueue
{
    ...
    {        
        ...
        $indicadoresService->offsetCAbc = 0;
        $indicadoresService->offsetBAbc = 0;
        $indicadoresService->offsetAAbc = 0;
        $indicadoresService->offsetCAbCd = 0;
        $indicadoresService->offsetBAbCd = 0;
        $indicadoresService->offsetAAbCd = 0;
