<table>
    <tr>
        ...
        <td colspan="8" style="font-size: 14pt; font-weight: bold; font-family: Arial; color: #17202A; vertical-align: middle;">
            {{ $titulo }}
        </td>
    </tr>
    <tr>
        <td>&nbsp;</td>
        <td colspan="8" style="font-size: 10pt; font-family: Arial;">
    ...
    @foreach ($articulos as $articulo)
        <tr style="background-color: #E7E6E6; font-family: Arial;">
            <td colspan="9" style="font-weight: bold; border: 1px solid #B4B4B4;">
