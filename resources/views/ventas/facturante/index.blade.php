...
<div class="row">
    <div class="col-lg-12">
        ...
        <form action="/anitaERP/public/ventas/generarfacturastiendanube" id="form-importar-facturas" data-action="/anitaERP/public/ventas/generarfacturastiendanube" class="form-horizontal form-label-right" method="POST" autocomplete="off">
            @csrf
